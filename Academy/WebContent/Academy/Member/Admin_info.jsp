                                    ...
                                    <div class="material-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <c:forEach var="memberList" items ="${memberList}">
                                                <tr>
                                                    <td><p class="text-info">${memberList.MEMBERNUM}</p></td>
                                                    <td><a href="AdminMemberInfo.se?id=${memberList.ID}">${memberList.ID}</a></td>
                                                    <td><a href="AdminMemberInfo.se?id=${memberList.ID}">${memberList.EMAIL}</a></td>
                                                    <td><a href="AdminMemberInfo.se?id=${memberList.ID}">${memberList.NAME}</a></td>
                                                    <td><a href="AdminMemberInfo.se?id=${memberList.ID}">${memberList.AGE}</a></td>
                                                    <td><a href="AdminMemberInfo.se?id=${memberList.ID}">${memberList.GENDER}</a></td>
                                                    <td><a href="AdminMemberInfo.se?id=${memberList.ID}">${memberList.PHONE}</a></td>
                                                    <td>
                                                    <c:choose>
                                                    <c:when test="${memberList.ID=='admin'}">
                                                    	<b>관리자</b>
                                                    </c:when>
                                                    <c:otherwise>
                                                    	<a href="AdminMemberDelete.se?id=${memberList.ID}" onclick="return confirm('회원 정보를 삭제하시겠습니까??');" class="btn btn-rose btn-fill">삭제</a>
                                                   </c:otherwise>
                                                    </c:choose>
                                                     </td>
                                                </tr>
