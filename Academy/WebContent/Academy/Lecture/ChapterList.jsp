                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            ...
                                            <c:forEach var = "list" items = "${playChapterList}" >
                                                <tr>
                                                    ...
                                                    <td><a href="playChapterViewAction.ac?playlist_num=${list.playlist_num }&category=${list.category }&order_num=${list.order_num }&lecture_level=${list.lecture_level }&lecture_image=${list.lecture_image }&id=<%=session.getAttribute("id")  %>">${list.chapter_subject }</a></td>
