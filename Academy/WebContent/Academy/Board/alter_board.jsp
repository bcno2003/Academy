           	...
           	<div class="row">
                ...
                <table class = "table table-striped" style="text-align: center ;border:1px solid #dddddd">
                  ...
                  <tr>
                    ...
                    <tr>
                           <!-- 내용 -->
                          <td><textarea id="summernote" type="type" class="form-control" placeholder="글내용" name="BOARD_CONTENT" maxlenght="2000" style="height:350px;">${sub.BOARD_CONTENT}</textarea></td>
                               <script>
